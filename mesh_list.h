...
namespace meshes {
	...
	inline mesh_bt textured_cube(texture_b &tex, shader_t shad) {
		std::vector<float> vertices = {
	...
	inline mesh_bt textured_light_cube(texture_b &tex, shader_lt shad) {
		std::vector<float> vertices = {
	...
	inline mesh_b lit_cube(shader_l shad) {
		std::vector<float> vertices = {
